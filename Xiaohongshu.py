...
if __name__ == '__main__':
    ...
    for i in allusers.l:
        ...
        newpath=avatorpath+f'{len(MyUtils.listfile(avatorpath))}.jijf'
        MyUtils.pagedownload(page.element('//*[@id="app"]/div/div//div[@class="left"]//img').get_attribute('src'),newpath)
